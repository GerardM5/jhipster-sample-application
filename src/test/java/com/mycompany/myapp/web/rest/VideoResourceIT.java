...
class VideoResourceIT {
    ...
    public static Video createEntity(EntityManager em) {
        Video video = new Video().name(DEFAULT_NAME).url(DEFAULT_URL).description(DEFAULT_DESCRIPTION).title(DEFAULT_TITLE);
        return video;
    }
    ...
    public static Video createUpdatedEntity(EntityManager em) {
        Video video = new Video().name(UPDATED_NAME).url(UPDATED_URL).description(UPDATED_DESCRIPTION).title(UPDATED_TITLE);
        return video;
    }
    ...
    void putNewVideo() throws Exception {
        ...
        updatedVideo.name(UPDATED_NAME).url(UPDATED_URL).description(UPDATED_DESCRIPTION).title(UPDATED_TITLE);
    ...
    void fullUpdateVideoWithPatch() throws Exception {
        ...
        partialUpdatedVideo.name(UPDATED_NAME).url(UPDATED_URL).description(UPDATED_DESCRIPTION).title(UPDATED_TITLE);
